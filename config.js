...
const config = {
  pageToken: process.env.pageToken, // Đưa token của fanpage của bạn vô đây.
  ...
  mode: 'CHAT', // dùng CHAT để chat vs bot hoặc bạn có thể chỉnh thành IMAGE để bot tạo ảnh nhé. 
